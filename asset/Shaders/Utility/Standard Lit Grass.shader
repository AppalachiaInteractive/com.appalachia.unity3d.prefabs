...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Grass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionMask137_g1894 = Packed_Grass1241;
			float2 temp_output_94_0_g1894 = ( ( lerpResult293_g1894 * MotionDirection59_g1894 ) * MotionMask137_g1894 );
			float2 break311_g1894 = temp_output_94_0_g1894;
			float3 appendResult308_g1894 = (float3(break311_g1894.x , 0.0 , break311_g1894.y));
			...
			half localunity_ObjectToWorld0w1_g1897 = ( unity_ObjectToWorld[0].w );
			...
			float3 lerpResult57_g1900 = lerp( temp_output_41_0_g1900 , -ase_vertex3Pos , ( 1.0 - max( unity_LODFade.x , step( unity_LODFade.x , 0.0 ) ) ));
				...
				float3 staticSwitch40_g1900 = lerpResult57_g1900;
			#else
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float3 break17_g1901 = UnpackScaleNormal( tex2D( BumpMap, uvBumpMap607 ), _NormalScale );
			...
			half3 MainBumpMap620 = appendResult18_g1901;
			...
			o.Albedo = saturate( ( Main_MainTex487 * Main_Color486 * Gloabl_Tint1208 ) ).rgb;
			...
			half4 OUT_TRANSMISSION1269 = ( Main_MetallicGlossMap_B1271 * _SubsurfaceColor );
			o.Transmission = OUT_TRANSMISSION1269.rgb;
			o.Alpha = 1;
			half Main_MainTex_A616 = tex2DNode18.a;
			float temp_output_41_0_g1903 = Main_MainTex_A616;
...
Node;AmplifyShaderEditor.GetLocalVarNode;1247;-512,256;Inherit;False;1241;Packed_Grass;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1248;-512,160;Inherit;False;1240;Motion_Turbulence;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1261;2048,-256;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;744;1536,-768;Half;False;Main_MetallicGlossMap_A;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexToFragmentNode;1205;-768,640;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;1260;1792,-64;Inherit;False;1240;Motion_Turbulence;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1267;2816,-896;Inherit;False;1271;Main_MetallicGlossMap_B;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1273;576,-896;Inherit;False;Normal BackFace;-1;;1901;121446c878db06f4c847f9c5afed7cfe;0;1;13;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1212;-1280,-2048;Inherit;False;1208;Gloabl_Tint;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;745;2240,-896;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1268;3136,-896;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;1083;-1280,-2112;Inherit;False;486;Main_Color;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;36;-1280,-2176;Inherit;False;487;Main_MainTex;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;616;-976,-768;Half;False;Main_MainTex_A;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;791;-1280,-1664;Inherit;False;616;Main_MainTex_A;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1074;-768,-2176;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1211;-1280,-1472;Inherit;False;1209;Global_Size;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1175;-1280,-1536;Inherit;False;1263;Motion_Output;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;654;-1280,-1824;Inherit;False;660;OUT_SMOOTHNESS;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1202;1008,-2688;Half;False;Property;_Internal_DebugVariation;Internal_DebugVariation;50;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;1109;-576,-2176;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;1236;-1280,-384;Inherit;False;3910.489;100;Motion;0;;0.03448272,1,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;1270;2816,-1024;Inherit;False;770.26;100;Transmission;0;;0.7843137,1,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1210;-1280,512;Inherit;False;1090.415;100;Globals;0;;1,0.7686275,0,1;0;0
...
ASEEND*/
//CHKSM=0BAE9C9EB7412F8C94749AF76C455253C1292059