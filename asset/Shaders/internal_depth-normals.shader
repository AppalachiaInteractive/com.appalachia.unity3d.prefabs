Shader "Hidden/appalachia/depth-normals" 
{
    ...
    SubShader
    {
        Tags { "RenderType" = "InternalOpaque" }
        Pass 
        {
            CGPROGRAM
            #include "UnityCG.cginc"
    ...
    SubShader
    {
        Tags { "RenderType" = "InternalMasked" }
        Pass 
        {
            CGPROGRAM
            #include "UnityCG.cginc"
