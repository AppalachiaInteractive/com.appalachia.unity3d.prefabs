...
Shader "GPUInstancer/internal/impostors/tree_runtime"
{
	Properties
	{
...
#pragma multi_compile_instancing
			...
			v2f_surf vert_surf (appdata_full v ) {
				...
				half localunity_ObjectToWorld0w1_g7389 = ( unity_ObjectToWorld[0].w );
				half localunity_ObjectToWorld1w2_g7389 = ( unity_ObjectToWorld[1].w );
				half localunity_ObjectToWorld2w3_g7389 = ( unity_ObjectToWorld[2].w );
				float3 appendResult6_g7389 = (float3(localunity_ObjectToWorld0w1_g7389 , localunity_ObjectToWorld1w2_g7389 , localunity_ObjectToWorld2w3_g7389));
				float3 temp_output_1050_510_g7308 = appendResult6_g7389;
				float2 temp_output_1_0_g7343 = (temp_output_1050_510_g7308).xz;
				float temp_output_2_0_g7347 = _WIND_BASE_TRUNK_FIELD_SIZE;
				float2 temp_cast_0 = (( 1.0 / (( temp_output_2_0_g7347 == 0.0 ) ? 1.0 :  temp_output_2_0_g7347 ) )).xx;
				float2 temp_output_2_0_g7343 = temp_cast_0;
				float2 temp_output_704_0_g7336 = ( (( 1.0 > 0.0 ) ? ( temp_output_1_0_g7343 / temp_output_2_0_g7343 ) :  ( temp_output_1_0_g7343 * temp_output_2_0_g7343 ) ) + float2( 0,0 ) );
				float temp_output_2_0_g7385 = _WIND_BASE_TRUNK_CYCLE_TIME;
				float temp_output_618_0_g7336 = ( 1.0 / (( temp_output_2_0_g7385 == 0.0 ) ? 1.0 :  temp_output_2_0_g7385 ) );
				float2 break298_g7340 = ( temp_output_704_0_g7336 + ( temp_output_618_0_g7336 * ( _Time.y + 0.0 ) ) );
				float2 appendResult299_g7340 = (float2(sin( break298_g7340.x ) , cos( break298_g7340.y )));
				float4 temp_output_273_0_g7340 = (-1.0).xxxx;
				float4 temp_output_271_0_g7340 = (1.0).xxxx;
				float2 clampResult26_g7340 = clamp( appendResult299_g7340 , temp_output_273_0_g7340.xy , temp_output_271_0_g7340.xy );
				float temp_output_1050_495_g7308 = _WIND_BASE_AMPLITUDE;
				float temp_output_1050_501_g7308 = _WIND_BASE_TO_GUST_RATIO;
				float temp_output_524_0_g7336 = ( temp_output_1050_495_g7308 * temp_output_1050_501_g7308 );
				float2 TRUNK_PIVOT_ROCKING701_g7336 = ( clampResult26_g7340 * temp_output_524_0_g7336 );
				float temp_output_2424_495 = v.color.r;
				float temp_output_2431_0 = ( temp_output_2424_495 * _PrimaryRollStrength );
				float _WIND_PRIMARY_ROLL669_g7336 = temp_output_2431_0;
				float temp_output_54_0_g7345 = ( TRUNK_PIVOT_ROCKING701_g7336 * 0.15 * _WIND_PRIMARY_ROLL669_g7336 ).x;
				float temp_output_72_0_g7345 = cos( temp_output_54_0_g7345 );
				float one_minus_c52_g7345 = ( 1.0 - temp_output_72_0_g7345 );
				float3 break70_g7345 = float3(0,1,0);
				float axis_x25_g7345 = break70_g7345.x;
				float c66_g7345 = temp_output_72_0_g7345;
				float axis_y37_g7345 = break70_g7345.y;
				float axis_z29_g7345 = break70_g7345.z;
				float s67_g7345 = sin( temp_output_54_0_g7345 );
				float3 appendResult83_g7345 = (float3(( ( one_minus_c52_g7345 * axis_x25_g7345 * axis_x25_g7345 ) + c66_g7345 ) , ( ( one_minus_c52_g7345 * axis_x25_g7345 * axis_y37_g7345 ) - ( axis_z29_g7345 * s67_g7345 ) ) , ( ( one_minus_c52_g7345 * axis_z29_g7345 * axis_x25_g7345 ) + ( axis_y37_g7345 * s67_g7345 ) )));
				float3 appendResult81_g7345 = (float3(( ( one_minus_c52_g7345 * axis_x25_g7345 * axis_y37_g7345 ) + ( axis_z29_g7345 * s67_g7345 ) ) , ( ( one_minus_c52_g7345 * axis_y37_g7345 * axis_y37_g7345 ) + c66_g7345 ) , ( ( one_minus_c52_g7345 * axis_y37_g7345 * axis_z29_g7345 ) - ( axis_x25_g7345 * s67_g7345 ) )));
				float3 appendResult82_g7345 = (float3(( ( one_minus_c52_g7345 * axis_z29_g7345 * axis_x25_g7345 ) - ( axis_y37_g7345 * s67_g7345 ) ) , ( ( one_minus_c52_g7345 * axis_y37_g7345 * axis_z29_g7345 ) + ( axis_x25_g7345 * s67_g7345 ) ) , ( ( one_minus_c52_g7345 * axis_z29_g7345 * axis_z29_g7345 ) + c66_g7345 )));
				float3 temp_output_38_0_g7345 = ( v.vertex.xyz - (float3(0,0,0)).xyz );
				float2 break298_g7337 = ( temp_output_704_0_g7336 + ( temp_output_618_0_g7336 * ( _Time.y + 0.0 ) ) );
				float2 appendResult299_g7337 = (float2(sin( break298_g7337.x ) , cos( break298_g7337.y )));
				float4 temp_output_273_0_g7337 = (-1.0).xxxx;
				float4 temp_output_271_0_g7337 = (1.0).xxxx;
				float2 clampResult26_g7337 = clamp( appendResult299_g7337 , temp_output_273_0_g7337.xy , temp_output_271_0_g7337.xy );
				float2 TRUNK_SWIRL700_g7336 = ( clampResult26_g7337 * temp_output_524_0_g7336 );
				float2 break699_g7336 = TRUNK_SWIRL700_g7336;
				float4 appendResult698_g7336 = (float4(break699_g7336.x , 0.0 , break699_g7336.y , 0.0));
				float4 temp_output_694_0_g7336 = ( float4( ( mul( float3x3(appendResult83_g7345, appendResult81_g7345, appendResult82_g7345), temp_output_38_0_g7345 ) - temp_output_38_0_g7345 ) , 0.0 ) + ( _WIND_PRIMARY_ROLL669_g7336 * appendResult698_g7336 ) );
				float4 color658_g7390 = IsGammaSpace() ? float4(0.1607843,0.0627451,0.2509804,0.1764706) : float4(0.02217388,0.005181517,0.05126947,0.1764706);
				float2 temp_output_61_0_g7400 = float2( 0,0 );
				float2 temp_output_1_0_g7405 = temp_output_1050_510_g7308.xy;
				float temp_output_2_0_g7395 = _WIND_GUST_TRUNK_FIELD_SIZE;
				float temp_output_40_0_g7400 = ( 1.0 / (( temp_output_2_0_g7395 == 0.0 ) ? 1.0 :  temp_output_2_0_g7395 ) );
				float2 temp_cast_9 = (temp_output_40_0_g7400).xx;
				float2 temp_output_2_0_g7405 = temp_cast_9;
				float temp_output_2_0_g7391 = _WIND_GUST_TRUNK_CYCLE_TIME;
				float mulTime37_g7400 = _Time.y * ( 1.0 / (( temp_output_2_0_g7391 == 0.0 ) ? 1.0 :  temp_output_2_0_g7391 ) );
				float temp_output_220_0_g7401 = -1.0;
				float4 temp_cast_10 = (temp_output_220_0_g7401).xxxx;
				float temp_output_219_0_g7401 = 1.0;
				float4 temp_cast_11 = (temp_output_219_0_g7401).xxxx;
				float4 clampResult26_g7401 = clamp( sin( ( ( tex2Dlod( _WIND_GUST_TEXTURE, float4( ( (( temp_output_61_0_g7400 > float2( 0,0 ) ) ? ( temp_output_1_0_g7405 / temp_output_2_0_g7405 ) :  ( temp_output_1_0_g7405 * temp_output_2_0_g7405 ) ) + temp_output_61_0_g7400 ), 0, 0.0) ) * ( 2.0 * UNITY_PI ) ) + mulTime37_g7400 ) ) , temp_cast_10 , temp_cast_11 );
				float4 temp_cast_12 = (temp_output_220_0_g7401).xxxx;
				float4 temp_cast_13 = (temp_output_219_0_g7401).xxxx;
				float4 temp_cast_14 = (0.0).xxxx;
				float4 temp_cast_15 = (temp_output_219_0_g7401).xxxx;
				float4 temp_cast_16 = (_WIND_GUST_CONTRAST).xxxx;
				float4 temp_output_52_0_g7400 = saturate( pow( abs( (temp_cast_14 + (clampResult26_g7401 - temp_cast_12) * (temp_cast_15 - temp_cast_14) / (temp_cast_13 - temp_cast_12)) ) , temp_cast_16 ) );
				float4 lerpResult656_g7390 = lerp( color658_g7390 , temp_output_52_0_g7400 , _WIND_GUST_TEXTURE_ON);
				float2 weightedBlendVar660_g7390 = (0.5).xx;
				float4 weightedBlend660_g7390 = ( weightedBlendVar660_g7390.x*(_WIND_GUST_AUDIO_STRENGTH).xxxx + weightedBlendVar660_g7390.y*lerpResult656_g7390 );
				float4 break655_g7390 = weightedBlend660_g7390;
				float temp_output_1046_630_g7308 = break655_g7390.x;
				float _WIND_GUST_STRENGTH703_g7336 = temp_output_1046_630_g7308;
				float _WIND_PRIMARY_BEND662_g7336 = ( temp_output_2424_495 * _PrimaryBendStrength );
				float temp_output_54_0_g7346 = ( ( _WIND_GUST_STRENGTH703_g7336 * -1.0 ) * _WIND_PRIMARY_BEND662_g7336 );
				float temp_output_72_0_g7346 = cos( temp_output_54_0_g7346 );
				float one_minus_c52_g7346 = ( 1.0 - temp_output_72_0_g7346 );
				float3 _WIND_DIRECTION671_g7336 = _WIND_DIRECTION;
				float4 transform641_g7336 = mul(unity_WorldToObject,float4( cross( _WIND_DIRECTION671_g7336 , float3(0,1,0) ) , 0.0 ));
				float3 break70_g7346 = transform641_g7336.xyz;
				float axis_x25_g7346 = break70_g7346.x;
				float c66_g7346 = temp_output_72_0_g7346;
				float axis_y37_g7346 = break70_g7346.y;
				float axis_z29_g7346 = break70_g7346.z;
				float s67_g7346 = sin( temp_output_54_0_g7346 );
				float3 appendResult83_g7346 = (float3(( ( one_minus_c52_g7346 * axis_x25_g7346 * axis_x25_g7346 ) + c66_g7346 ) , ( ( one_minus_c52_g7346 * axis_x25_g7346 * axis_y37_g7346 ) - ( axis_z29_g7346 * s67_g7346 ) ) , ( ( one_minus_c52_g7346 * axis_z29_g7346 * axis_x25_g7346 ) + ( axis_y37_g7346 * s67_g7346 ) )));
				float3 appendResult81_g7346 = (float3(( ( one_minus_c52_g7346 * axis_x25_g7346 * axis_y37_g7346 ) + ( axis_z29_g7346 * s67_g7346 ) ) , ( ( one_minus_c52_g7346 * axis_y37_g7346 * axis_y37_g7346 ) + c66_g7346 ) , ( ( one_minus_c52_g7346 * axis_y37_g7346 * axis_z29_g7346 ) - ( axis_x25_g7346 * s67_g7346 ) )));
				float3 appendResult82_g7346 = (float3(( ( one_minus_c52_g7346 * axis_z29_g7346 * axis_x25_g7346 ) - ( axis_y37_g7346 * s67_g7346 ) ) , ( ( one_minus_c52_g7346 * axis_y37_g7346 * axis_z29_g7346 ) + ( axis_x25_g7346 * s67_g7346 ) ) , ( ( one_minus_c52_g7346 * axis_z29_g7346 * axis_z29_g7346 ) + c66_g7346 )));
				float3 temp_output_38_0_g7346 = ( v.vertex.xyz - (float3(0,0,0)).xyz );
				float temp_output_1050_498_g7308 = _WIND_GUST_AMPLITUDE;
				float smoothstepResult551_g7336 = smoothstep( 0.0 , 1.0 , temp_output_1050_498_g7308);
				float4 lerpResult538_g7336 = lerp( temp_output_694_0_g7336 , ( temp_output_694_0_g7336 + float4( ( mul( float3x3(appendResult83_g7346, appendResult81_g7346, appendResult82_g7346), temp_output_38_0_g7346 ) - temp_output_38_0_g7346 ) , 0.0 ) ) , smoothstepResult551_g7336);
				float3 temp_output_41_0_g7422 = (( ( _WIND_TRUNK_STRENGTH * lerpResult538_g7336 ) + float4( ( _WIND_BRANCH_STRENGTH * float3(0,0,0) ) , 0.0 ) + float4( ( _WIND_LEAF_STRENGTH * float3(0,0,0) ) , 0.0 ) )).xyz;
				float3 temp_cast_23 = (0.0).xxx;
				float temp_output_63_0_g7423 = (( unity_LODFade.x >= 1E-05 && unity_LODFade.x <= 0.99999 ) ? unity_LODFade.x :  1.0 );
				float3 lerpResult57_g7423 = lerp( temp_cast_23 , -v.vertex.xyz , ( 1.0 - temp_output_63_0_g7423 ));
				#ifdef INTERNAL_LODFADE_SCALE
				float3 staticSwitch58_g7422 = lerpResult57_g7423;
				#else
				float3 staticSwitch58_g7422 = temp_output_41_0_g7422;
				#endif
				#ifdef LOD_FADE_CROSSFADE
				float3 staticSwitch62_g7422 = staticSwitch58_g7422;
				#else
				float3 staticSwitch62_g7422 = temp_output_41_0_g7422;
				#endif
				...
				v.vertex.xyz += staticSwitch62_g7422;
			...
			fixed4 frag_surf (v2f_surf IN, out float outDepth : SV_Depth ) : SV_Target {
				...
				float temp_output_41_0_g7428 = o.Alpha;
				float4 screenPos = IN.ase_texcoord10;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 clipScreen45_g7429 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither45_g7429 = Dither8x8Bayer( fmod(clipScreen45_g7429.x, 8), fmod(clipScreen45_g7429.y, 8) );
				float temp_output_56_0_g7429 = (( unity_LODFade.x >= 1E-05 && unity_LODFade.x <= 0.99999 ) ? unity_LODFade.x :  1.0 );
				dither45_g7429 = step( dither45_g7429, temp_output_56_0_g7429 );
				#ifdef INTERNAL_LODFADE_DITHER
				float staticSwitch50_g7428 = ( temp_output_41_0_g7428 * dither45_g7429 );
				#else
				float staticSwitch50_g7428 = temp_output_41_0_g7428;
				#endif
				#ifdef LOD_FADE_CROSSFADE
				float staticSwitch56_g7428 = staticSwitch50_g7428;
				#else
				float staticSwitch56_g7428 = temp_output_41_0_g7428;
				#endif
				...
				fixed alpha = staticSwitch56_g7428;
...
/*ASEBEGIN
Version=17500
0;0;1280;659;-1847.49;2679.18;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;2430;1280,-1440;Inherit;False;Property;_PrimaryRollStrength;Primary Roll Strength;26;0;Create;True;0;0;False;0;0.1;4;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2431;1664,-1696;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2408;1087,-2195;Inherit;True;Property;_WAOTS;WAOTS;5;0;Create;True;0;0;False;0;None;266aa5801f6a9bc41ab3130d73dcff34;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;2438;1631.032,-2620.198;Inherit;False;Property;_BrightnessAdjustment;Brightness Adjustment;22;0;Create;True;0;0;False;0;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2469;1632,-2432;Inherit;False;Property;_ContrastCorrection;Contrast Correction;23;0;Create;True;0;0;False;0;1;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2436;1631.032,-2812.198;Inherit;False;Property;_HueAdjustment;Hue Adjustment;20;0;Create;True;0;0;False;0;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;2470;1880.989,-1761.34;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2439;1631.032,-2524.198;Inherit;False;Property;_ContrastAdjustment;Contrast Adjustment;24;0;Create;True;0;0;False;0;1;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2437;1631.032,-2716.198;Inherit;False;Property;_SaturationAdjustment;Saturation Adjustment;21;0;Create;True;0;0;False;0;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.AmplifyImpostorNode;2401;1546.638,-2185.041;Inherit;False;9603;HemiOctahedron;True;False;True;10;11;12;9;8;0;7;6;1;2;4;3;13;14;15;16;17;1;Metallic;8;0;SAMPLER2D;;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;SAMPLER2D;;False;6;SAMPLER2D;;False;7;SAMPLER2D;;False;17;FLOAT4;8;FLOAT4;9;FLOAT4;10;FLOAT4;11;FLOAT4;12;FLOAT4;13;FLOAT4;14;FLOAT4;15;FLOAT3;0;FLOAT3;1;FLOAT3;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT3;7;FLOAT3;16
Node;AmplifyShaderEditor.ColorNode;2443;2377.365,-2332.365;Inherit;False;Property;_FadeVariation;Fade Variation;18;0;Create;True;0;0;True;0;1,1,1,0.2784314;1,1,1,0.2784314;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2429;1280,-1344;Inherit;False;Property;_PrimaryBendStrength;Primary Bend Strength;25;0;Create;True;0;0;False;0;0.125;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;2463;2376.872,-2543.627;Inherit;False;Property;_CorrectContrast;CorrectContrast;33;0;Create;True;0;0;False;0;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;2455;1920,-1712;Inherit;False;Wind (Tree Simple);27;;7308;e08118e08be3b4140bb32f9f7d5cc4cb;2,981,0,983,0;6;1152;FLOAT;0;False;1153;FLOAT;0;False;1154;FLOAT;0;False;1155;FLOAT;0;False;1156;FLOAT;0;False;1157;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2388;2551.29,-1788.038;Inherit;False;Execute LOD Fade;-1;;7421;18ea34bd83a0d6c4db425672111543e6;0;2;41;FLOAT;0;False;58;FLOAT3;0,0,0;False;3;FLOAT;0;FLOAT3;91;FLOAT;96
...
Node;AmplifyShaderEditor.DynamicAppendNode;2420;1792,-1408;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;2441;1188.835,-2483.177;Inherit;False;Property;_HueVariation;Hue Variation;19;0;Create;True;0;0;True;0;0,0,0,0;0.7416955,0.85,0.2655126,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;2453;3110.266,-2432.113;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;2366;3841.442,-1853.644;Inherit;False;Internal Features Support;-1;;7420;3c493d142aeebd840af72d626f6915c6;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2396;3601.808,-1984.133;Float;False;True;-1;2;ASEMaterialInspector;0;10;GPUInstancer/internal/impostors/tree_runtime;30a8e337ed84177439ca24b6a5c97cd1;True;ForwardBase;0;0;ForwardBase;10;False;False;True;False;True;0;False;-1;False;False;False;False;False;True;4;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=True;ImpostorType=HemiOctahedron;True;4;0;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ForwardBase;False;0;;1;=;0;Standard;1;Material Type,InvertActionOnDeselection;0;0;5;True;True;True;True;True;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2398;3601.808,-1706.133;Float;False;False;-1;2;ASEMaterialInspector;0;10;New Amplify Shader;30a8e337ed84177439ca24b6a5c97cd1;True;Deferred;0;2;Deferred;0;False;False;True;False;True;0;False;-1;False;False;False;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=True;True;2;0;False;False;False;False;False;False;False;False;False;True;1;LightMode=Deferred;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2400;3601.808,-1640.133;Float;False;False;-1;2;ASEMaterialInspector;0;10;New Amplify Shader;30a8e337ed84177439ca24b6a5c97cd1;True;ShadowCaster;0;4;ShadowCaster;0;False;False;True;False;True;0;False;-1;False;False;False;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=True;True;2;0;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2399;3601.808,-1673.133;Float;False;False;-1;2;ASEMaterialInspector;0;10;New Amplify Shader;30a8e337ed84177439ca24b6a5c97cd1;True;Meta;0;3;Meta;0;False;False;True;False;True;0;False;-1;False;False;False;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=True;True;2;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2397;3601.808,-1739.133;Float;False;False;-1;2;ASEMaterialInspector;0;10;New Amplify Shader;30a8e337ed84177439ca24b6a5c97cd1;True;ForwardAdd;0;1;ForwardAdd;0;False;False;True;False;True;0;False;-1;False;False;False;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=True;True;2;0;True;4;1;False;-1;1;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;True;2;False;-1;False;False;True;1;LightMode=ForwardAdd;False;0;;0;0;Standard;0;0
...
WireConnection;2455;1152;2431;0
WireConnection;2455;1153;2432;0
...
WireConnection;2388;58;2455;0
WireConnection;2402;0;2401;8
WireConnection;2420;0;2424;495
WireConnection;2420;1;2424;501
WireConnection;2420;2;2424;550
WireConnection;2420;3;2424;552
...
ASEEND*/
//CHKSM=8BFD115EF9CEAA76BBF39D6F00706BF0CA124721
