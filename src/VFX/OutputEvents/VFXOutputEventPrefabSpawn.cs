    ...
    public class VFXOutputEventPrefabSpawn : VFXOutputEventAbstractHandler
    {
        ...
        public override void OnVFXOutputEvent(VFXEventAttribute eventAttribute)
        {
            ...
            if (freeIdx != -1)
            {
                ...
                var handlers = availableInstance
                   .GetComponentsInChildren<VFXOutputEventPrefabAttributeAbstractHandler>();
        ...
        {
            var rebuild = m_Instances.Length != m_InstanceCount;
#if UNITY_EDITOR
            if (m_Dirty)
            {
                rebuild = true;
            ...
            if (rebuild)
            {
                ...
                if ((m_PrefabToSpawn != null) && (m_InstanceCount != 0))
                {
                    ...
                    for (var i = 0; i < m_Instances.Length; i++)
                    {
                        ...
                        {
                            newInstance =
                                UnityEditor.PrefabUtility.InstantiatePrefab(m_PrefabToSpawn) as GameObject;
                        }
...
#pragma warning disable 414, 649
        ...
        private uint m_InstanceCount = 5;
        ...
        [SerializeField,
         Tooltip(
             "Whether to attach prefab instances to current game object. Use this setting to treat position and angle attributes as local space."
         )]
