...
namespace Appalachia.Rendering.Prefabs.Rendering
{
    internal static partial class PKG
    {
        ...
        public const string Prefix = Root + "Rendering/Prefabs/Rendering/";
        public const int Priority = 1000*74;
...
// MODIFICATIONS ALLOWED: START
        public static partial class Menu
        {
            public static partial class Appalachia
            {
                public static partial class Tools
                {
                    public static class RuntimeRendering
                    {
                    ...
                    public static class Bounce
                    {
                        ...
                        public const int Priority = PKG.Priority + 40;
                    }
                }
            }
        }
        public static partial class Prefs
        {
            public static partial class Gizmos
            {
                public const string GameView = Base + "GameView/";
            }
