...
namespace Appalachia.Rendering.Prefabs.Rendering
{
    ...
    public static class PrefabLabelInitializer
    {
        ...
        static PrefabLabelInitializer()
        {
            ...
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.VegetationVerySmall,
                LABELS.LABEL_VegetationVerySmall
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.VegetationSmall,
                LABELS.LABEL_VegetationSmall
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.VegetationMedium,
                LABELS.LABEL_VegetationMedium
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.VegetationLarge,
                LABELS.LABEL_VegetationLarge
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.VegetationVeryLarge,
                LABELS.LABEL_VegetationVeryLarge
            );

            LabelManager.RegisterEnumTypeLabels(PrefabModelType.TreeSmall, LABELS.LABEL_TreeSmall);
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.TreeMedium,
                LABELS.LABEL_TreeMedium
            );
            LabelManager.RegisterEnumTypeLabels(PrefabModelType.TreeLarge, LABELS.LABEL_TreeLarge);

            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.ObjectVerySmall,
                LABELS.LABEL_ObjectVerySmall
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.ObjectSmall,
                LABELS.LABEL_ObjectSmall
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.ObjectMedium,
                LABELS.LABEL_ObjectMedium
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.ObjectLarge,
                LABELS.LABEL_ObjectLarge
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.ObjectHuge,
                LABELS.LABEL_ObjectHuge
            );

            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.AssemblySmall,
                LABELS.LABEL_AssemblySmall
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.AssemblyMedium,
                LABELS.LABEL_AssemblyMedium
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.AssemblyLarge,
                LABELS.LABEL_AssemblyLarge
            );
            LabelManager.RegisterEnumTypeLabels(
                PrefabModelType.AssemblyHuge,
                LABELS.LABEL_AssemblyHuge
            );
            ...
            LabelManager.RegisterEnumTypeLabels(
                PrefabContentType.GroundCover,
                LABELS.LABEL_GroundCover
            );
            ...
            LabelManager.RegisterEnumTypeLabels(
                PrefabContentType.AquaticPlant,
                LABELS.LABEL_AquaticPlant
            );
